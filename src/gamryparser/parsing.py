...
class Parser():
    def __init__(self, filepath, lines, experiment, dataframes, scanrate, stepsize, time, date):
    ...
    def from_file(cls, filepath):
        ...
        dataframes = cls.parse_tables_from_lines(lines, experiment, scanrate, stepsize)

        return cls(filepath, lines, experiment, dataframes, scanrate, stepsize, time, date)


    @staticmethod
    def parse_tables_from_lines(lines, experiment, scanrate, stepsize):
        ...
        table_indices.append(len(lines_dataframe)) 
